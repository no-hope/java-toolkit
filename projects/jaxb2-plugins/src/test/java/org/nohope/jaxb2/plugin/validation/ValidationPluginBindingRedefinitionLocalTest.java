...
public class ValidationPluginBindingRedefinitionLocalTest extends Jaxb2PluginTestSupport {
    public ValidationPluginBindingRedefinitionLocalTest() {
        super("validation", "org/nohope/jaxb2/codegen/validation/redefinition_local");
    }
