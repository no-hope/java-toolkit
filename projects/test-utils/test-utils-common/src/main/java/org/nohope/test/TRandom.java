...
public final class TRandom {
     ...
     * <ul>
     *     <li>{@code A} for {@link org.nohope.test.TRandom#UPPER upper case} letter</li>
     *     <li>{@code a} for {@link org.nohope.test.TRandom#LOWER lower case} letter</li>
     *     <li>{@code #} for {@link org.nohope.test.TRandom#DIGIT digit}</li>
     *     <li>{@code !} for {@link org.nohope.test.TRandom#SPECIAL special character}</li>
     * </ul>
     *
     * Example:
     * <pre>
