...
public class JacksonProcessorTest {
    private static final ObjectMapper MAPPER = TypeSafeObjectMapper.createPreConfiguredMapper();
    ...
    public void testEscaping() {
        ...
        final String escaped = TypeSafeObjectMapper.escape(source);
        assertEquals("text hash1=\\# hash2=\\\\# hash3=\\\\\\# dot=_ at=\\@ underscore=\\_ underscore2=\\\\_", escaped);

        final String restored = TypeSafeObjectMapper.unescape(escaped);
